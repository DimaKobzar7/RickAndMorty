  ...
  return (
    <footer className={footerStyles["footer"]}>
      <div className={footerStyles["footer__body"]}>
        <h2 className={footerStyles["footer__text"]}>
          performed as part of a test case for the company
        </h2>
        <div className={footerStyles["footer__wrap"]}>
          <img className={footerStyles["footer__img"]} src={logo} alt='' />
          <img src={background} alt='' />
        </div>
        <div className={footerStyles["footer__inner"]}>
          <Link to='#'>
            <svg
              className={footerStyles["footer__social"]}
        ...
        <p className={footerStyles["footer__year"]}>2023</p>
      </div>
    </footer>
  );
};
